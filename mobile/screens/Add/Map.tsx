...
export default function Map( props: any, ref: any ) {
    ...
    function changeMap() {
        if ( props.requestLocation != ' ' ) {
            const url = `https://us1.locationiq.com/v1/search.php?key=pk.ca7d72d67098fe33153685abf70e35a9&q=${ props.requestLocation }&format=json`
    ...
    return (
        <View style={[
            props.requestLocation != ' ' ? {} : { display: 'none' }
        ]}>
            <View style={{
                flexDirection: 'row',
                marginTop: 50,
